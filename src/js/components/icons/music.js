    ...
    render() {
        ...
        return (
            <svg className="svg-icon" id="music" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width} height={height} viewBox="0 0 35.7 34.8">
                ...
                <g id="notes">
                    <path id="note_1" fill="none" stroke={basicfill} d="M19.3,27.5c0,0-0.3-1.7-2.2-1.1c-1.8,0.6-0.9,2.8,0.4,2.7c1.3-0.1,2-0.8,2-3.2c0-2.4-0.1-5.6-0.1-5.6s0.9,1.4,1.7,1.7s0.6,1.7,0.6,1.7"/>
                    <path id="note_2" fill="none" stroke={basicfill} d="M16.7,18.1c0,0-0.3-1.4-1.9-1c-1.6,0.5-0.8,2.4,0.4,2.3c1.2-0.1,1.8-0.7,1.7-2.8s-0.1-4.9-0.1-4.9s0.8,1.3,1.5,1.5s0.5,1.5,0.5,1.5"/>
                </g>
            </svg>
        );
    }
